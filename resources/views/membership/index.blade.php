...
@section('content')
    ...
    <div class="relative h-96 bg-cover bg-center"
        style="background-image: url('https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=1920&h=600&fit=crop');">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="bg-white rounded-2xl shadow-lg p-8 hover:shadow-2xl transition transform hover:-translate-y-2">
                    <div class="text-center mb-6">
                        <div
                            class="w-20 h-20 bg-linear-to-br from-orange-400 to-orange-600 rounded-full mx-auto mb-4 flex items-center justify-center">
                            <span class="text-3xl">🥉</span>
                        </div>
                        <h3 class="text-2xl font-serif font-bold mb-2">Bronze</h3>
                        <p class="text-4xl font-bold text-gray-900 mb-2">$99<span class="text-lg text-gray-500">/year</span>
                        </p>
                    </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg p-8 hover:shadow-2xl transition transform hover:-translate-y-2">
                    <div class="text-center mb-6">
                        <div
                            class="w-20 h-20 bg-linear-to-br from-gray-300 to-gray-500 rounded-full mx-auto mb-4 flex items-center justify-center">
                            <span class="text-3xl">🥈</span>
                        </div>
                        <h3 class="text-2xl font-serif font-bold mb-2">Silver</h3>
                        <p class="text-4xl font-bold text-gray-900 mb-2">$199<span
                                class="text-lg text-gray-500">/year</span></p>
                    </div>
                    <ul class="space-y-3 mb-8">
                        <li class="flex items-start">
                            <svg class="w-5 h-5 text-green-500 mr-2 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                ...
                <!-- Gold -->
                <div
                    class="bg-linear-to-br from-gold-400 to-gold-600 rounded-2xl shadow-2xl p-8 transform scale-105 relative">
                    <div
                        class="absolute -top-4 left-1/2 -translate-x-1/2 bg-red-500 text-black px-4 py-1 rounded-full text-sm font-bold">
                        MOST POPULAR
                    </div>
                    <div class="text-center mb-6">
                        <div class="w-20 h-20 bg-blue-400 rounded-full mx-auto mb-4 flex items-center justify-center">
                            <span class="text-3xl">🥇</span>
                        </div>
                        <h3 class="text-2xl font-serif font-bold mb-2 text-black">Gold</h3>
                        <p class="text-4xl font-bold text-black mb-2">$399<span class="text-lg text-yellow-500">/year</span>
                        </p>
                    </div>
                    <ul class="space-y-3 mb-8">
                        <li class="flex items-start">
                    ...
                    <button onclick="openMembershipModal('gold')"
                        class="w-full bg-blue-400 hover:bg-gray-100 text-gold-600 font-bold py-3 rounded-lg transition shadow-lg">
                        Select Gold
                    </button>
                </div>
                ...
                <!-- Platinum -->
                <div
                    class="bg-green-300 rounded-2xl shadow-lg p-8 hover:shadow-2xl transition transform hover:-translate-y-2 border-2 border-primary-600">
                    <div class="text-center mb-6">
                        <div
                            class="w-20 h-20 bg-linear-to-br from-primary-500 to-primary-700 rounded-full mx-auto mb-4 flex items-center justify-center">
                            <span class="text-3xl">💎</span>
                        </div>
                        <h3 class="text-2xl font-serif font-bold mb-2">Platinum</h3>
                        <p class="text-4xl font-bold text-gray-900 mb-2">$799<span
                                class="text-lg text-gray-500">/year</span></p>
                    </div>
                    <ul class="space-y-3 mb-8">
                        <li class="flex items-start">
                    ...
                    <button onclick="openMembershipModal('platinum')"
                        class="w-full bg-primary-600 hover:bg-primary-700 text-black font-semibold py-3 rounded-lg transition">
                        Select Platinum
                    </button>
                </div>
            </div>
