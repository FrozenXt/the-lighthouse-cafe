...
@section('content')
    ...
    <div class="mb-8 flex items-center gap-4">
        ...
        <div>
            <h1 class="text-4xl font-serif font-bold text-slate-800">Edit Category</h1>
            <p class="text-slate-600 mt-2">Update "{{ $category->name }}"</p>
        </div>
    </div>
            ...
            <div>
                <label class="flex items-center gap-3 cursor-pointer">
                    <input type="checkbox" id="is_active" name="is_active" value="1"
                        {{ old('is_active', $category->is_active) ? 'checked' : '' }} class="w-5 h-5 rounded text-teal-600">
