...
<header class="fixed w-full z-50 bg-black/80 backdrop-blur border-b border-yellow-500/20">
    <div class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <button class="bg-yellow-400 text-black px-5 py-2 rounded-full font-semibold hover:bg-yellow-300 transition">
            Become a Member
        </button>
    </div>
</header>
...
<section class="h-screen flex items-center justify-center relative overflow-hidden">
    ...
    <div class="relative z-10 text-center max-w-3xl px-6">
        ...
        <div class="flex justify-center gap-6">
            <button class="bg-yellow-400 text-black px-8 py-3 rounded-full font-semibold hover:bg-yellow-300 transition">
                Explore Menu
            </button>
            <button class="border border-yellow-400 px-8 py-3 rounded-full hover:bg-yellow-400 hover:text-black transition">
                Featured Dishes
            </button>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid md:grid-cols-3 gap-10">
            ...
            <div class="bg-yellow-400 text-black rounded-2xl overflow-hidden shadow-xl">
                <img src="https://images.unsplash.com/photo-1551218808-94e220e084d2" class="h-56 w-full object-cover">
                <div class="p-6">
            ...
            <div class="bg-yellow-400 text-black rounded-2xl overflow-hidden shadow-xl">
                <img src="https://images.unsplash.com/photo-1604908554025-e477d44c15f6" class="h-56 w-full object-cover">
                <div class="p-6">
