...
@section('content')
<!-- Hero -->
<div class="relative h-80 bg-cover bg-center" style="background-image: url('https://images.unsplash.com/photo-1530554764233-e79e16c91d08?w=1920&h=600&fit=crop');">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-2xl shadow-2xl p-8 md:p-12">
            <div class="text-center mb-12">
                ...
                <p class="text-gray-600">Please fill out the form below and we'll confirm your reservation within 24 hours</p>
            </div>
            ...
            <form action="{{ route('reservations.store') }}" method="POST" class="space-y-6">
                ...
                <div class="bg-primary-50 border border-primary-200 rounded-lg p-4">
                    <p class="text-sm text-gray-700">
                        <strong>Please note:</strong> Reservations are subject to availability. We will confirm your booking via email within 24 hours. For same-day reservations, please call us at (415) 555-0123.
                    </p>
                </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="text-center p-6">
                ...
                <p class="text-gray-600">Mon-Thu: 11am - 10pm<br>Fri-Sat: 11am - 11pm<br>Sun: 10am - 9pm</p>
            </div>
            ...
            <div class="text-center p-6">
                ...
                <p class="text-gray-600">123 Harbor Drive<br>San Francisco, CA 94111</p>
            </div>
            ...
            <div class="text-center p-6">
                ...
                <p class="text-gray-600">(415) 555-0123<br>info@lighthousecafe.com</p>
            </div>
        </div>
    </div>
</section>
