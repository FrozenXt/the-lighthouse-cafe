...
<body class="bg-slate-100">
    ...
    <div class="flex items-center" :class="!sidebarOpen && 'justify-center'">
        ...
        <!-- Logo -->
        <div class="w-10 h-10 rounded-full overflow-hidden shadow-lg flex-shrink-0">
            <img
                src="{{ site_setting('site_logo')
                    ? asset('storage/' . site_setting('site_logo'))
                    : asset('images/lighthouselogo.png') }}"
        ...
        <div x-show="sidebarOpen" x-transition class="ml-3">
            <h2 class="font-serif font-bold text-lg text-amber-400">
                {{ site_setting('site_name', 'Lighthouse') }}
            </h2>
...
<a href="{{ route('admin.orders.index') }}"
                ...
                <a href="{{ route('admin.categories.index') }}"
                    class="flex items-center px-4 py-3 mb-2 rounded-lg transition {{ request()->routeIs('admin.categories*') ? 'bg-amber-500 text-slate-900' : 'hover:bg-slate-700' }}">
                    <svg class="w-6 h-6 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
   ...
   {{ request()->routeIs('admin.contacts*') ? 'bg-amber-500 text-slate-900' : 'hover:bg-slate-700 text-slate-200' }}">
        ...
        Contacts
                ...
                <a href="{{ route('menu') }}" target="_blank"
                  ...
                  <a href="{{ route('admin.settings.index') }}"
                    class="flex items-center px-4 py-3 mb-2 rounded-lg transition {{ request()->routeIs('admin.settings*') ? 'bg-amber-500 text-slate-900' : 'hover:bg-slate-700' }}">
                    <svg class="w-6 h-6 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
            ...
            <div class="border-t border-slate-700">
                <div class="p-4">
                    <div class="flex items-center" :class="!sidebarOpen && 'justify-center'">
                        <div
                            class="w-10 h-10 bg-slate-700 rounded-full flex items-center justify-center flex-shrink-0">
                            <span
